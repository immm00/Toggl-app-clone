...
import {UserFilter} from "../UserFilterInput";
...
export const Projects = ({ projects }: Props) => {
  ...
  const [userFilterInput, setUserFilterInput] = useState<string | undefined>(undefined)
  ...
  return (
   <>
     ...
     <UserFilter handleChange={handleInputChange}/>
     <ProjectList projects={userFilterInput === undefined ? projects : projects.filter((item)=>item.user_name.toLowerCase().startsWith(userFilterInput.toLowerCase()))} onSelect={selectProject} onToggle={toggleProject} />
   </>
  )
}